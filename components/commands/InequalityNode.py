...
class InequalityNode(OperatorNode):
    ...
    def selected(self):
        ...
        """
        sub_select_img = pygame.image.load("assets/ineq_select.png")
    ...
    def __init__(self, next_node, loc: Tuple[float, float]):
        super().__init__(next_node, 2, loc, './assets/ineq.png')  # needs 2 operands
